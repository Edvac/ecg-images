...
setwd("/home/george/Data/RR intervals/shareedb/RRouts-test")
files <- list.files(path = "/home/george/Data/RR intervals/shareedb/RRouts-test",
                    pattern = "*.txt",
                    full.names = TRUE,
                    recursive = FALSE)  
...
for (i in 1:length(files)){
    ...
    # fullFileName <- "/home/george/Data/RR intervals/shareedb/RRouts-test/rr02062.txt"
